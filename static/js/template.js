 ...
 **/
;
var LOG = typeof (window['console']) == 'object' ? console.log : function() {
};
var ERR = typeof (window['console']) == 'object' ? console.error : window.alert;
...
function Template(tpl){
    ...
    obj.parse = function() {
        ...
        var text = obj.tpl;
        var scriptArr = [ '"use strict";var view = "";' ];
        var str = [];
